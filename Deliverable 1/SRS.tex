...
<<<<<<< HEAD
		Is a web application for simulating the effects on controlling Great Britain\cite{BBC}. The application advances with 10 year turns, each turn allows a specific set of decisions to be made. Each decision effects just Great Britain. The overall goal is to become a no-emissions country within 200 years. \\
=======
...
>>>>>>> 9ee38bfd57529bf1fc5595c4527730e2146f5200
