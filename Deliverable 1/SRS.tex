...
\begin{itemize}
	...
	%LINK: http://www.bbc.co.uk/sn/hottopics/climatechange/climate_challenge/
		...
		\end{itemize}
	%\item \textbf{http://www.bbc.co.uk/sn/hottopics/climatechange/climate_challenge/}
	%\item \textbf{http://monash.edu/research/simple-climate-model/mscm/greb/cgi-bin/scny_i18n.py?scenario=28&variable=02&locale=EN&activetab=undefined}
	%\item \textbf{https://play.google.com/store/apps/details?id=com.gz.EnergyWars}
\end{itemize}
